package com.rias.sharing.life.user.service.aliyun.impl;
...
import com.rias.sharing.life.user.constant.CommonConstant;
...
public class AscServiceImpl implements AcsService {
    ...
    public boolean sendValidateCode(String phone, String code, String id) {
        ...
        //请求成功
        if(sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals(CommonConstant.OK)) {
